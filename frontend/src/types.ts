...
export type User = { id: string; _id?: string; name: string; email: string; phone: string; city: string; institutionName: string; designation: string; role: Role; createdAt: string; classCount?: number; studentCount?: number; classes?: ClassItem[] };
